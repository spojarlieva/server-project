...
const getEvents = async () => {
    try {
        const response = await fetch("https://server-project-production-3a0b.up.railway.app/events")
        if (!response.ok) {
...
const getRegisteredEvents = async (token) => {
    try {
        const response = await fetch("https://server-project-production-3a0b.up.railway.app/events/registered", {
            headers: {
                ...
                checkBox.addEventListener("change", async () => {
                    ...
                    try {
                        const response = await fetch(
                            `https://server-project-production-3a0b.up.railway.app/events/register/${event.id}`,
                            {
